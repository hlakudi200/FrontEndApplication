"use client";
import { Form, Input, Button, Select, DatePicker, Switch, message, Flex, Spin,} from "antd";
  ...
  return (
    <>
     <Form
      ...
      style={{ maxWidth: 700, margin: "0 auto", padding: 20, backgroundColor: "#2c2a2a", borderRadius: 20 ,marginBottom:20,}}
    >
      ...
      <Form.Item label="Active State" name="activeState" valuePropName="checked">
        <Switch />
      </Form.Item>
